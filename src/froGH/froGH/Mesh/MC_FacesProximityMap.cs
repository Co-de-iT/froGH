...
namespace froGH
{
    public class MC_FacesProximityMap : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the MC_FaceProximityMap class.
        /// </summary>
        public MC_FacesProximityMap()
          : base("Mesh Connectivity - Faces Proximity Map", "f_MC-FPM",
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Resources.FacesProximityMap_GH;
            }
        }
