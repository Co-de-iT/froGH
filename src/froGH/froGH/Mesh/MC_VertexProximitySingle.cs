...
namespace froGH
{
    public class MC_VertexProximitySingle : GH_Component
    {
        ...
        protected override void RegisterOutputParams(GH_Component.GH_OutputParamManager pManager)
        {
            ...
            pManager.AddIntegerParameter("Connected faces", "vF", "Indexes of connected vertices to this vertex", GH_ParamAccess.list);
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            faces = M.Vertices.GetVertexFaces(i);  //.Select(x => new GH_Integer(x));

            // fill edges data tree
            edges = M.TopologyVertices.ConnectedEdges(M.TopologyVertices.TopologyVertexIndex(i));//.Select(x => new GH_Integer(x));


            // fill vertices data tree
            vertices = M.Vertices.GetConnectedVertices(i);//.Select(x => new GH_Integer(x));
