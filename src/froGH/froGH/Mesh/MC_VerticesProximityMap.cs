...
namespace froGH
{
    public class MC_VerticesProximityMap : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the MC_VertexProximityMap class.
        /// </summary>
        public MC_VerticesProximityMap()
          : base("Mesh Connectivity - Vertices Proximity Map", "f_MC-VPM",
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Resources.VertexProximityMap_GH;
            }
        }
