...
namespace froGH
{
    public class ExportCurvesToAI : GH_Component
    {
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddBooleanParameter("Preserve Units", "PU", "Preserve Units option", GH_ParamAccess.item, true);
            pManager.AddBooleanParameter("View Bound", "VB", "View Bound option", GH_ParamAccess.item, true);
            pManager.AddBooleanParameter("Color Style", "CS", "Color Style option\nTrue for RGB, false for CMYK", GH_ParamAccess.item, true);
            pManager.AddBooleanParameter("Solid Hatch", "SH", "Solid Hatch option", GH_ParamAccess.item, true);
            pManager.AddBooleanParameter("Order Layers", "OL", "Order Layers option", GH_ParamAccess.item, true);
